...
public class ATrapperSelector<SendInMessageType, SendOutMessageType> 
	extends AReceiveTrapperSelector<SendInMessageType, SendOutMessageType>
	implements TrapperSelector<SendInMessageType, SendOutMessageType> {	
...
//				retVal = currentTrapper;
	...
	public static boolean containsObjectofSameClass (List aList, Object aValue) {
		for (Object o: aList) {
			if (o.getClass().equals(aValue.getClass())) {
				return true;
			}				
		}
		return false;
	}
	// allows different supports to add the same factory multiple times
	public static void addIfObjectofDifferentClass (List aList, Object aValue) {
		if (!containsObjectofSameClass(aList, aValue)) {
			aList.add(aValue);
		}
	}
	@Override
...
//			sendFactories.add (sendTrapperFactory); 
			addIfObjectofDifferentClass(sendFactories, sendTrapperFactory);
		}
	}
//	@Override
//	public ReceiveTrapper<SendOutMessageType, SendInMessageType> createReceiveTrapper(
