...
public class ProposalLearnNotificationtReceived extends TraceableInfo {
	...
	public ProposalLearnNotificationtReceived(String aMessage, Object aSource, String anObjectName, int aProposalNumber, Object aProposal) {
		super(aMessage, aSource );
	}
	
	
	public static ProposalLearnNotificationtReceived newCase(Object aSource, String anObjectName, int aProposalNumber, Object aProposal) {
