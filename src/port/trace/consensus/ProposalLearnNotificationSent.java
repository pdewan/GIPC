...
public class ProposalLearnNotificationSent extends TraceableInfo {
	...
	public ProposalLearnNotificationSent(String aMessage, Object aSource, String anObjectName, float aProposalNumber, Object aProposal, boolean anAgreement) {
		super(aMessage, aSource );
	}
	
	
	public static ProposalLearnNotificationSent newCase(Object aSource, String anObjectName, float aProposalNumber, Object aProposal, boolean anAgreement) {
