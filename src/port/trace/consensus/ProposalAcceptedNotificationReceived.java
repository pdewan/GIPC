...
public class ProposalAcceptedNotificationReceived extends TraceableInfo {
	...
	public ProposalAcceptedNotificationReceived(String aMessage, Object aSource, String anObjectName, float aProposalNumber, Object aProposal, boolean anAgreement) {
		super(aMessage, aSource );
	}
	
	
	public static ProposalAcceptedNotificationReceived newCase(Object aSource, String anObjectName, float aProposalNumber, Object aProposal, boolean anAgreement) {
