...
public class GIPCMVCCounterClient2Launcher extends GIPCMVCCounterClientLauncher {
	
	
	public static void main (String[] args) {	
		try {
			setTracing();
			GIPCRegistry rmiRegistry = GIPCLocateRegistry.getRegistry(SERVER_HOST_NAME, SERVER_PORT, "client2");
