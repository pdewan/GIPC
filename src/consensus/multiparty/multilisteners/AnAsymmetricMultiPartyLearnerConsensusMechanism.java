...
public class AnAsymmetricMultiPartyLearnerConsensusMechanism<StateType> 
	extends AnAsymmetricTwoPartyLearnerConsensusMechanism<StateType> 
	implements MultiPartyLearner<StateType>{

	public AnAsymmetricMultiPartyLearnerConsensusMechanism(
	...
	public void prepare(float aProposalNumber, StateType aProposal) {
		...
		proposer().prepared(aProposalNumber, aProposal);
