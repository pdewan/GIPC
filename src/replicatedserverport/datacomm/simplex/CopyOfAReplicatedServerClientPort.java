...
//	String clientName;
	public CopyOfAReplicatedServerClientPort(GroupMultiServerClientPort<MessageType> aMultiUserPort, String aLogicalServerName) {
...
//			sendTrapper = trapperSelector.createSendTrapper(this, uniToAllSendTrapper);
	...
	protected SendTrapper<MessageType, MessageType> createSendTrapper() {
...
//	}
	...
	public void notifyConnect(String remoteEnd, ConnectionType aConnectionType) {
		groupMultiServerClientPort.notifyConnect(remoteEnd, null);
	}
	@Override
